...
class TextDocument extends EventEmitter {
  ...
  setTextColor(start: number, end: number, color: string): void {
    this.formatAttribute(start, end, "textColor", color);
  ...
  setBackgroundColor(start: number, end: number, color: string): void {
    this.formatAttribute(start, end, "backgroundColor", color);
